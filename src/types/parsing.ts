...
export type MatcherNode = RegexNode | OredicNode | MatcherOperatorNode | AstNode;

export type OperatorNode = AndNode | OrNode | XorNode;
export type MatcherOperatorNode = MatcherAndNode | MatcherOrNode | MatcherXorNode;

export type LexemeElement = TextLexeme | OperatorLexeme | NegationLexeme | WildcardLexeme | GroupLexeme;
...
export type Token = { type: NodeNames.TEXT; content: string } | { type: NodeNames.WILDCARD };
