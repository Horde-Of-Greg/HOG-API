...
export const EnvFileSchema = z.object({
    ...
    REDIS_PASSWORD: z.string().min(8, "Password is too short. Change your DB's password."),
    REDIS_HOST: z.string(),
...
export type EnvSchema = z.infer<typeof EnvFileSchema>;
export type ConfigSchema = z.infer<typeof ConfigFileSchema>;
export type FiltersSchema = z.infer<typeof FiltersConfigFileSchema>;
