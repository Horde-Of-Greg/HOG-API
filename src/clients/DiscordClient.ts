...
export class DiscordClient {
    ...
    static gatewayIntents = [GatewayIntentBits.Guilds, GatewayIntentBits.GuildMembers];
...
export function getDiscordClient(): DiscordClient {
    if (!discordClient) throw new Error("Discord Client not initialized. Call initDiscordClient() first.");
    return discordClient;
}
